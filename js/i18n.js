...
const translations = {
  en: {
    ...
    whatsAppPickupReminder: 'Hello {name}, this is a reminder that your blazer pickup is today ({date}). We will have it ready for you.\n\nMadhusanka Tailors, Dankotuwa',
    whatsAppReturnReminder: 'Hello {name}, just a quick reminder that your blazer return is due today! {date}. Thank you.\n\nMadhusanka Tailors, Dankotuwa\n\nWe would also love to hear your feedback!\n👉 Leave us a review ⭐\nhttps://g.page/r/CWe0j4fj9KpbEBE/review',
    whatsAppUpcomingReminder: 'Hello {name}, this is a reminder about your upcoming blazer booking on {date}. We look forward to seeing you.\n\nMadhusanka Tailors, Dankotuwa',
    ...
    shareReceiptWhatsAppText: 'Hello {name}, your rental receipt is ready. Please find the PDF attached.',
    shareBillWhatsAppText: 'Hello {name}, your bill {number} is ready. Please find the PDF attached.',
    toastWhatsAppPhoneMissing: 'Add a customer mobile number before sharing on WhatsApp.',
  ...
  si: {
    ...
    whatsAppPickupReminder: 'ආයුබෝවන් {name}, ඔබගේ බ්ලේසර් ගැනීම අද ({date}) බව මතක් කරමු. එය ඔබ වෙනුවෙන් සූදානම් කර ඇත.\n\nමධුසංක ටේලර්ස්, දන්කොටුව',
    whatsAppReturnReminder: 'ආයුබෝවන් {name}, ඔයාගෙ බ්ලේසර් එක රිටන් කරන්න තියෙන්නේ අද {date} කියලා පොඩි මතක් කිරීමක්! ස්තුතියි.\n\nමධුසංක ටේලර්ස්, දන්කොටුව\n\nඔබගේ අදහස් දැනගැනීමට අපි කැමතියි!\n👉 අපට review එකක් ලබා දෙන්න ⭐\nhttps://g.page/r/CWe0j4fj9KpbEBE/review',
    whatsAppUpcomingReminder: 'ආයුබෝවන් {name}, ඔබගේ ඉදිරි බ්ලේසර් වෙන්කිරීම {date} දිනට ඇති බව මතක් කරමු. ඔබව හමුවීමට බලාපොරොත්තු වෙමු.\n\nමධුසංක ටේලර්ස්, දන්කොටුව',
    ...
    shareReceiptWhatsAppText: 'ආයුබෝවන් {name}, ඔබගේ කුලී රිසිට්පත සූදානම්. කරුණාකර PDF එක අමුණා ඇත.',
    shareBillWhatsAppText: 'ආයුබෝවන් {name}, ඔබගේ බිල් අංක {number} සූදානම්. කරුණාකර PDF එක අමුණා ඇත.',
    toastWhatsAppPhoneMissing: 'WhatsApp හරහා යැවීමට පෙර පාරිභෝගික මොබයිල් අංකයක් එක් කරන්න.',
