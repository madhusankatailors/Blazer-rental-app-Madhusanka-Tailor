...
const translations = {
  en: {
    ...
    btnShareWhatsApp: 'Share WhatsApp',
    ...
    toastReceiptSharedWhatsApp: 'Receipt shared via WhatsApp!',
  ...
  si: {
    ...
    btnShareWhatsApp: 'WhatsApp හරහා බෙදා ගන්න',
    ...
    toastReceiptSharedWhatsApp: 'රිසිට් WhatsApp හරහා බෙදා ගනු ලදී!',
