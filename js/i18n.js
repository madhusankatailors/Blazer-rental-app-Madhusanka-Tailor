...
const translations = {
  en: {
    ...
    customersTitle: "Customer Profiles",
    customersSubtitle: "Rentals, bills, shoe sales, and payments in one view",
    customersDirectory: "Customer Directory",
    customersDirectoryHint: "Search by name, phone, or customer ID.",
    customersSearchPlaceholder: "Search customers...",
    customersTotal: "Customers",
    customersWithRentals: "With rentals",
    customersOutstanding: "Outstanding",
    customersEmpty: "No customers match your search.",
    customersUnknown: "Unknown customer",
    customersRecords: "records",
    customersNoPhone: "No phone number",
    customersBalance: "Balance",
    customersPayments: "Payments",
    customersLastActivity: "Last activity",
    customersRentals: "rentals",
    customersBills: "bills",
    customersShoeSales: "shoe sales",
    customersRental: "Rental",
    customersBill: "Bill",
    customersShoeSale: "Shoe sale",
    customersPayment: "Payment",
    customersReceived: "Received",
    customersFromDate: "From date",
    customersToDate: "To date",
    customersRecordType: "Record type",
    customersAllRecords: "All records",
    customersBalanceFilter: "Balance",
    customersAllBalances: "All balances",
    customersBalanceDue: "Balance due",
    customersPaidInFull: "Paid in full",
    customersSortBy: "Sort by",
    customersLatestActivity: "Latest activity",
    customersName: "Name",
    customersHighestBalance: "Highest balance",
    customersClearFilters: "Clear filters",
    customersPrevious: "Previous",
    customersNext: "Next",
    customersShowing: "Showing {from}–{to} of {total}",
    customersViewDetails: "View full profile",
    customersOpenBilling: "Open bills / create bill",
    customersFullHistory: "Full history",
    customersEditBill: "Edit bill",
    langEnglish: "English",
    langSinhala: "සිංහල",
    ...
    calendarTitle: "Rental Calendar",
    calendarSubtitle: "Pickup and return bookings at a glance",
    calendarPickup: "Pickup",
    calendarUpcoming: "Upcoming pickup",
    calendarReturn: "Return",
    calendarOverdue: "Overdue",
    calendarTodayReminderOption: "Enable WhatsApp reminder for today's pickup",
    calendarNoBookings: "No bookings for this date.",
    calendarToday: "Today",
    ...
    blazersHint:
      "Add one or more blazer codes for this customer. Total price is calculated automatically.",
    ...
    restorePreviewChoice:
      "Choose Merge to keep existing bookings, or Replace to remove current bookings first.",
    btnRestoreMerge: "Merge with Existing",
    btnRestoreReplace: "Replace All Data",
    helpTitle: "Quick help",
    helpText:
      "Use Details to view, edit, print receipts, collect balances, or mark a booking returned.",
    ...
    placeholderNotes:
      "e.g. needs alteration, wedding on Saturday, special instructions...",
    alertRequiredFields: "Please fill in all required fields.",
    dialogErrorTitle: "Please check the form",
    ...
    dialogDelete: "Delete",
    dialogClear: "Clear",
    alertPhoneNumberInvalid: "Phone numbers must contain exactly 10 digits.",
    phoneDigitsProgress: "{count}/10 digits entered.",
    phoneDigitsValid: "10 digits ready.",
    phoneDigitsInvalid: "Use exactly 10 digits.",
    alertBlazerRequired:
      "Please enter a blazer code and color for each blazer.",
    alertAdvanceRequired: "Please enter how much the customer advance money.",
    alertAdvanceTooMuch:
      "Paid amount must be less than the total. Choose Paid in Full instead.",
    ...
    backOnline: "Back online. Syncing your latest changes...",
    syncSaving: "Saving...",
    ...
    toastWhatsAppPhoneMissing:
      "Add a customer mobile number before sharing on WhatsApp.",
    toastPdfUnavailable:
      "PDF download is unavailable. Check your internet connection and try again.",
    toastRestoreInvalid:
      "This backup file is invalid or contains no booking records.",
    toastRestoreSuccess: "Backup restored successfully.",
    confirmRestoreMerge:
      "Merge {count} backup records with your existing bookings?",
    confirmRestoreReplace:
      "Replace ALL existing bookings with {count} backup records? This cannot be undone.",
    ...
    billingPhoneCustomerHint:
      "Optional. The same phone number automatically links bills to one customer profile.",
    ...
    billingPaymentUnpaidHint:
      "Nothing has been paid yet. The full total remains due.",
    billingPaymentAdvanceHint:
      "Enter the amount received now. The remaining balance is calculated automatically.",
    billingPaymentFullHint:
      "The full bill total is marked as paid automatically.",
    billingCollectBalance: "Collect Balance",
    billingConfirmCollectBalance:
      "Collect {amount} for bill {number} and mark it Paid in Full?",
    billingToastBalanceCollected:
      "Balance collected. Bill is now Paid in Full.",
    billingOtherItemName: "Other item name",
    billingOtherItemPlaceholder: "Type custom item name...",
    billingAddItemHint:
      "Each selection adds a new line. Select Other as many times as needed.",
    billingRemoveItem: "Remove",
    billingItemAction: "Action",
    billingItems: "Bill Items",
    billingItemsHint:
      "Add items one by one. They will appear on the bill in the same order you add them.",
    ...
    billingCustomerProfilesHint:
      "Phone number is the Customer ID. Bills with the same phone number stay together in one profile.",
    billingCustomerSearchPlaceholder: "Search customer name or phone...",
    billingCustomerEmpty: "No customer profiles yet.",
    billingCustomerEmptyHint:
      "Save a bill with a phone number to create a customer profile automatically.",
    ...
    billingSavedHint:
      "Cloud-synced bills can be previewed, edited, downloaded, or deleted.",
    ...
    billingTerms:
      "Wedding garments must be returned on the agreed date. Damage or loss will be charged according to the amount determined by the establishment. Late returns are subject to a Rs. 200/- charge per day.",
    ...
    billingErrorPhone:
      "Please enter the customer phone number. It is used as the Customer ID.",
    billingErrorPhoneInvalid:
    ...
    billingConfirmClear:
      "Clear all customer, payment and item details and start a new bill?",
  ...
  si: {
    ...
    calendarTitle: "කුලී දින දර්ශනය",
    calendarSubtitle: "ගැනීම් සහ ආපසු දීම් එකම තැනකින් බලන්න",
    calendarPickup: "ගැනීම",
    calendarUpcoming: "ඉදිරි ගන්නා දිනය",
    calendarReturn: "ආපසු දෙන දිනය",
    calendarOverdue: "ප්‍රමාද",
    calendarTodayReminderOption:
      "අද ගන්නා දිනය සඳහා WhatsApp මතක් කිරීම සක්‍රීය කරන්න",
    calendarNoBookings: "මෙම දිනයට වෙන්කිරීම් නොමැත.",
    calendarToday: "අද",
    calendarCollapse: "දින දර්ශනය වසන්න",
    ...
    blazersHint:
      "මෙම පාරිභෝගිකයා සඳහා එක් හෝ වැඩි බ්ලේසර් කේත එකතු කරන්න. මුළු මිල ස්වයංක්‍රීයව ගණනය වේ.",
    ...
    restoreBackupHint:
      "ප්‍රතිස්ථාපනය කිරීමට පෙර JSON උපස්ථයක් තෝරා පෙරදසුන බලන්න.",
    ...
    restorePreviewChoice:
      "පවතින වෙන්කිරීම් තබා ගැනීමට එකතු කරන්න තෝරන්න. සියල්ල ප්‍රතිස්ථාපනය කිරීමට ප්‍රතිස්ථාපනය තෝරන්න.",
    btnRestoreMerge: "පවතින දත්ත සමඟ එකතු කරන්න",
    btnRestoreReplace: "සියලු දත්ත ප්‍රතිස්ථාපනය",
    helpTitle: "ඉක්මන් උදව්",
    helpText:
      "විස්තර මඟින් බැලීම, සංස්කරණය, රිසිට් ප්‍රින්ට් කිරීම, ඉතිරි මුදල් ගැනීම හෝ ආපසු ලබා දුන් ලෙස සලකුණු කිරීම කරන්න.",
    ...
    btnShareWhatsApp: "WhatsApp හරහා යවන්න",
    ...
    placeholderNotes:
      "උදා: අලුත්වැඩියාව අවශ්‍ය, සෙනසුරාදා විවාහය, විශේෂ උපදෙස්...",
    alertRequiredFields: "කරුණාකර අවශ්‍ය සියලුම ක්ෂේත්‍ර පුරවන්න.",
    dialogErrorTitle: "පෝරමය පරීක්ෂා කරන්න",
    dialogConfirmTitle: "කරුණාකර තහවුරු කරන්න",
    dialogOK: "හරි",
    dialogConfirm: "තහවුරු කරන්න",
    dialogCancel: "අවලංගු කරන්න",
    dialogDelete: "මකන්න",
    dialogClear: "හිස් කරන්න",
    alertPhoneNumberInvalid: "දුරකථන අංකයේ ඉලක්කම් හරියටම 10ක් තිබිය යුතුය.",
    phoneDigitsProgress: "ඉලක්කම් {count}/10ක් ඇතුළත් කර ඇත.",
    phoneDigitsValid: "ඉලක්කම් 10 සම්පූර්ණයි.",
    phoneDigitsInvalid: "හරියටම ඉලක්කම් 10ක් ඇතුළත් කරන්න.",
    ...
    alertAdvanceTooMuch:
      "ගෙවූ මුදල මුළු මිලට වඩා අඩු විය යුතුය. සම්පූර්ණ ගෙවීම තෝරන්න.",
    ...
    toastWhatsAppPhoneMissing:
      "WhatsApp හරහා යැවීමට පෙර පාරිභෝගික මොබයිල් අංකයක් එක් කරන්න.",
    toastPdfUnavailable:
      "PDF බාගත කිරීම නොමැත. අන්තර්ජාල සම්බන්ධතාවය පරීක්ෂා කර නැවත උත්සාහ කරන්න.",
    toastRestoreInvalid:
      "මෙම උපස්ථ ගොනුව වලංගු නැත හෝ වෙන්කිරීම් වාර්තා නොමැත.",
    toastRestoreSuccess: "උපස්ථය සාර්ථකව ප්‍රතිස්ථාපනය කරන ලදී.",
    confirmRestoreMerge:
      "උපස්ථ වාර්තා {count} ක් පවතින වෙන්කිරීම් සමඟ එකතු කරන්නද?",
    confirmRestoreReplace:
      "පවතින සියලුම වෙන්කිරීම් උපස්ථ වාර්තා {count} කින් ප්‍රතිස්ථාපනය කරන්නද? මෙය ආපසු හැරවිය නොහැක.",
    ...
    navBilling: "බිල්",
    navShoes: "සපත්තු",
    navCustomers: "පාරිභෝගිකයින්",
    customersTitle: "පාරිභෝගික පැතිකඩ",
    customersSubtitle: "කුලී, බිල්, සපත්තු අලෙවි සහ ගෙවීම් එකම තැනකින්",
    customersDirectory: "පාරිභෝගික ලැයිස්තුව",
    customersDirectoryHint: "නම, දුරකථන අංකය හෝ පාරිභෝගික ID මගින් සොයන්න.",
    customersSearchPlaceholder: "පාරිභෝගිකයින් සොයන්න...",
    customersTotal: "පාරිභෝගිකයින්",
    customersWithRentals: "කුලී ඇති",
    customersOutstanding: "ගෙවීමට ඇති",
    customersEmpty: "ඔබේ සෙවුමට ගැලපෙන පාරිභෝගිකයින් නැත.",
    customersUnknown: "නොදන්නා පාරිභෝගිකයා",
    customersRecords: "වාර්තා",
    customersNoPhone: "දුරකථන අංකයක් නැත",
    customersBalance: "ශේෂය",
    customersPayments: "ගෙවීම්",
    customersLastActivity: "අවසාන ක්‍රියාකාරකම",
    customersRentals: "කුලී",
    customersBills: "බිල්",
    customersShoeSales: "සපත්තු අලෙවි",
    customersRental: "කුලී",
    customersBill: "බිල්",
    customersShoeSale: "සපත්තු අලෙවිය",
    customersPayment: "ගෙවීම",
    customersReceived: "ලැබුණි",
    customersFromDate: "ආරම්භක දිනය",
    customersToDate: "අවසන් දිනය",
    customersRecordType: "වාර්තා වර්ගය",
    customersAllRecords: "සියලු වාර්තා",
    customersBalanceFilter: "ශේෂය",
    customersAllBalances: "සියලු ශේෂ",
    customersBalanceDue: "ගෙවීමට ඇති",
    customersPaidInFull: "සම්පූර්ණයෙන් ගෙවා ඇත",
    customersSortBy: "අනුපිළිවෙළ",
    customersLatestActivity: "අලුත්ම ක්‍රියාකාරකම",
    customersName: "නම",
    customersHighestBalance: "වැඩිම ශේෂය",
    customersClearFilters: "පෙරහන් ඉවත් කරන්න",
    customersPrevious: "පෙර",
    customersNext: "ඊළඟ",
    customersShowing: "{total} න් {from}–{to} පෙන්වයි",
    customersViewDetails: "සම්පූර්ණ පැතිකඩ බලන්න",
    customersOpenBilling: "බිල් විවෘත කරන්න / බිලක් සාදන්න",
    customersFullHistory: "සම්පූර්ණ ඉතිහාසය",
    customersEditBill: "බිල සංස්කරණය කරන්න",
    offlineMode:
      "අන්තර්ජාල සම්බන්ධතාව නැත. වෙනස්කම් මෙම උපාංගයේ සුරැකී නැවත සම්බන්ධ වූ විට sync වේ.",
    backOnline: "නැවත සම්බන්ධ විය. නවතම වෙනස්කම් sync කරමින්...",
    ...
    billingFormHint:
      "බිල් විස්තර ඇතුළත් කරන්න. බිල් අංකය ඔබ විසින්ම ඇතුළත් කළ යුතුය.",
    ...
    billingPhoneCustomerHint:
      "අත්‍යවශ්‍ය නොවේ. එකම දුරකථන අංකය බිල් එකම පාරිභෝගික පැතිකඩකට ස්වයංක්‍රීයව සම්බන්ධ කරයි.",
    ...
    billingPaymentAdvanceHint:
      "දැන් ලැබුණු මුදල ඇතුළත් කරන්න. ඉතිරි මුදල ස්වයංක්‍රීයව ගණනය වේ.",
    billingPaymentFullHint:
      "මුළු බිල් මුදල ස්වයංක්‍රීයව ගෙවා ඇත ලෙස සලකුණු වේ.",
    billingCollectBalance: "ඉතිරි මුදල ගන්න",
    billingConfirmCollectBalance:
      "බිල් අංක {number} සඳහා {amount} ලබාගෙන සම්පූර්ණයෙන් ගෙවා ඇත ලෙස සලකුණු කරන්නද?",
    billingToastBalanceCollected:
      "ඉතිරි මුදල ලබාගන්නා ලදී. බිල දැන් සම්පූර්ණයෙන් ගෙවා ඇත.",
    billingOtherItemName: "වෙනත් අයිතමයේ නම",
    billingOtherItemPlaceholder: "අයිතමයේ නම ඇතුළත් කරන්න...",
    billingAddItemHint:
      "තෝරාගැනීමක් සෑම විටම නව පේළියක් එක් කරයි. අවශ්‍ය වාර ගණනක් “වෙනත්” තෝරාගත හැක.",
    billingRemoveItem: "ඉවත් කරන්න",
    billingItemAction: "ක්‍රියාව",
    billingItems: "බිල් අයිතම",
    billingItemsHint:
      "අයිතම එකින් එක එක් කරන්න. ඔබ එක් කරන අනුපිළිවෙළටම ඒවා බිලේ පෙන්වයි.",
    ...
    billingCustomerProfilesHint:
      "දුරකථන අංකය පාරිභෝගික ID ලෙස භාවිතා වේ. එකම අංකයට අදාළ සියලු බිල් එකම පැතිකඩ තුළ තබා ගනී.",
    billingCustomerSearchPlaceholder: "නම හෝ දුරකථන අංකය සොයන්න...",
    billingCustomerEmpty: "තවම පාරිභෝගික පැතිකඩ නොමැත.",
    billingCustomerEmptyHint:
      "දුරකථන අංකයක් සමඟ බිලක් සුරකින්න. පැතිකඩ ස්වයංක්‍රීයව සෑදේ.",
    ...
    billingSavedHint:
      "Cloud එකේ සුරකින බිල් පෙරදසුන්, සංස්කරණය, PDF බාගැනීම හෝ මකා දැමීම කළ හැක.",
    ...
    billingTerms:
      "ඔබ ලබාගන්නා මංගල ඇඳුම් නියමිත දිනට ආපසු භාර දිය යුතු අතර, කිසියම් පලුදු වීමක් හෝ අලාභහානියක් සිදු වූවහොත් ඒ සඳහා ආයතනය විසින් නියම කරනු ලබන ගෙවීම් සිදු කළ යුතුය. නියමිත දිනට ආපසු භාර නොදුනහොත් එක් දිනකට රු. 200/- බැගින් දඩ මුදලක් අය කෙරේ.",
    ...
    billingErrorPhone:
      "කරුණාකර පාරිභෝගික දුරකථන අංකය ඇතුළත් කරන්න. එය පාරිභෝගික ID ලෙස භාවිතා වේ.",
    billingErrorPhoneInvalid:
      "පාරිභෝගික දුරකථන අංකයේ ඉලක්කම් හරියටම 10ක් තිබිය යුතුය.",
    ...
    billingConfirmClear:
      "පාරිභෝගික, ගෙවීම් සහ අයිතම සියල්ල හිස් කර නව බිලක් ආරම්භ කරන්නද?",
...
function initI18n() {
  ...
  document
    .getElementById("langSi")
    ?.addEventListener("click", () => setLocale("si"));
}
