...
const translations = {
  en: {
    ...
    billingSelectItem: 'Select Bill Item',
    billingSelectItemPlaceholder: 'Choose an item...',
    billingSelectedItems: 'Selected Items',
    billingNoSelectedItems: 'No items selected yet.',
    billingItem: 'Item',
    billingQty: 'Qty',
  ...
  si: {
    ...
    billingSelectItem: 'බිල් අයිතමය තෝරන්න',
    billingSelectItemPlaceholder: 'අයිතමයක් තෝරන්න...',
    billingSelectedItems: 'තෝරාගත් අයිතම',
    billingNoSelectedItems: 'තවම අයිතම තෝරා නැත.',
    billingItem: 'අයිතමය',
    billingQty: 'ප්‍රමාණය',
